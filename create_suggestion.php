...
<html lang="en">
  <head>
    ...
    <title>Create Suggestions Page</title>
  ...
  <body ng-app="prinuk" ng-controller="createSuggestionCtrl" class="background-pattern" ng-cloak>
    ...
    <script src="/dist/js/create_suggestion.js"></script>
